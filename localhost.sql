...
--
-- Servidor: localhost
-- Tempo de Geração: 28/08/2017 às 17h58min
...
--
-- Banco de Dados: `gissa`
--
CREATE DATABASE `gissa` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
USE `gissa`;
...
INSERT INTO `paciente` (`idPaciente`, `Nome`, `idade`, `altura`, `peso`) VALUES
(1, 'Vinicius', 18, 1.81, 89),
(2, 'Nunes', 20, 2.1, 100),
(3, 'Barbosa', 30, 1.3, 20);
--
-- Banco de Dados: `hidromania`
--
CREATE DATABASE `hidromania` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `hidromania`;
...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `hipertensao` varchar(3) DEFAULT NULL,
  `Exercitando` varchar(5) DEFAULT NULL,
  `diabetes` varchar(100) DEFAULT NULL,
  `asma` varchar(100) DEFAULT NULL,
  `osteoporose` varchar(100) DEFAULT NULL,
  `problemascoluna` varchar(100) DEFAULT NULL,
  `hidroginastica` varchar(100) DEFAULT NULL,
  `dorarticular` varchar(100) DEFAULT NULL,
  `problemascardiacos` varchar(100) DEFAULT NULL,
  `artrite` varchar(100) DEFAULT NULL,
  `problemasneurologicos` varchar(100) DEFAULT NULL,
  `natacao` varchar(100) DEFAULT NULL,
  `implantesmetalicos` varchar(100) DEFAULT NULL,
  `alergia` varchar(100) DEFAULT NULL,
  `proteseouortese` varchar(100) DEFAULT NULL,
  `outros` varchar(255) DEFAULT NULL,
  `condicionamentofisico` varchar(100) NOT NULL,
  `lazer` varchar(100) NOT NULL,
  `aprendizagem` varchar(100) NOT NULL,
  `terapeutico` varchar(100) NOT NULL,
...
INSERT INTO `clientes` (`id`, `nome`, `endereco`, `datanascimento`, `bairro`, `fone`, `email`, `hora`, `dias`, `inicio`, `peso`, `altura`, `idade`, `hipertensao`, `Exercitando`, `diabetes`, `asma`, `osteoporose`, `problemascoluna`, `hidroginastica`, `dorarticular`, `problemascardiacos`, `artrite`, `problemasneurologicos`, `natacao`, `implantesmetalicos`, `alergia`, `proteseouortese`, `outros`, `condicionamentofisico`, `lazer`, `aprendizagem`, `terapeutico`, `turno`, `turma`) VALUES
(1, 'Conceição de Maria Giló Lima ', 'Castorina Pinto 1888', '05/12/1987', 'Várzea da Matriz', '3421-2487', '', '07:00', 'segunda-quarta-sexta', '11/01/2016', '', '', '65', 'Não', 'Não', 'Diabetes', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Manhã', 'Hidroginastica'),
(2, 'Cosma Barbosa do Nascimento', '', '  /  /    ', '', '', '', '07:00', 'quinta -sexta', '  /  /    ', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', ' ', 'Selecione', 'Natação'),
(3, 'Josefa Araújo de Oliveira', 'Quixaba', '14/02/1945', '', '(88)9 81087974', '', '07:00', 'segunda-quarta-sexta', '01/09/2014', '', '', '', 'Sim', 'Sim', 'Diabetes', ' ', ' ', 'Problemas de Coluna', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Manhã', ''),
(4, 'Iolanda Eduarda da Costa ', '', '  /  /    ', '', '', '', '07:00', 'segunda-quarta-sexta', '14/03/2016', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', ' ', 'Selecione', ''),
(5, 'Maria da Penha de Castro', 'Corrego dos Rodrigues ', '18/06/1952', '', '(88)9 97917664', '', '07:00', 'segunda-quarta-sexta', '11/01/2016', '', '', '64', 'Não', 'Sim', ' ', ' ', ' ', ' ', 'Hidroginástica', 'Dor Articular', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Joelho operado', ' ', ' ', ' ', 'Terapêutico', 'Manhã', ''),
(6, 'Maria José de Oliveira', 'Tv. Filismino Filho', '08/11/1951', 'Várzea da Matriz', '(88)9 99001217', '', '07:00', 'segunda-quarta-sexta', '13/07/2016', '', '', '65', 'Não', 'Sim', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', 'Alergia', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Manhã', ''),
(7, 'Marluce Silva Santos', 'Rua Santos Dumont  92', '01/10/1951', '', '(88)9 99710973', '', '07:00', 'segunda-quarta-sexta', '09/11/2015', '', '', '64', 'Sim', 'Sim', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Manhã', ''),
(9, 'Maria Izolda Gomes Dionísio ', 'Dragão do Mar ', '27/12/1946', 'Centro', '(88)9 99198875', '', '07:00', 'segunda-quarta-sexta', '15/02/2016', '', '', '69', 'Sim', 'Sim', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Manhã', ''),
(10, 'Maria do Socorro Gois Pinto', 'Rua Coronel Alexandrino 64', '15/05/1958', 'centro', '(88)9 99117626', '', '07:00', 'terça-quart-quinta-sexta', '15/02/2016', '', '', '57', 'Sim', 'Sim', ' ', ' ', ' ', ' ', 'Hidroginástica', 'Dor Articular', ' ', ' ', ' ', ' ', ' ', ' ', 'Tem Prótese ou Órteses', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Selecione', ''),
(11, 'Maria de Lourde Bastista Damasceno', 'Rua São Pedro 922', '16/04/1951', '', '(88) 9 99140234', '', '07:00', 'terça-quarta-quinta', '17/02/2016', '', '', '64', 'Sim', 'Sim', ' ', ' ', 'Osteoporose', ' ', 'Hidroginástica', 'Dor Articular', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Selecione', ''),
(12, 'Maria Correia de Melo', 'Rua Carolina Pereira do Santos ', '29/06/1950', 'Fátima', '3446-3172', '', '07:00', 'segunda-quart-sexta', '21/01/2016', '', '', '', 'Sim', 'Sim', ' ', ' ', ' ', 'Problemas de Coluna', 'Hidroginástica', ' ', ' ', 'Artrite', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', 'Terapêutico', 'Manhã', ''),
(14, 'Neuza Perreira da Silva', 'Rua Dragão do Mar ', '23/08/1938', 'Centro', '', '', '07:00', 'segunda-quart-sexta', '18/01/2016', '', '', '', 'Sim', 'Sim', ' ', ' ', ' ', ' ', 'Hidroginástica', 'Dor Articular', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', 'Terapêutico', 'Selecione', ''),
(15, 'Raimunda Lucia Carvalho da Silva ', 'Tv. Filismino Filho 1134', '26/02/1961', '', '(88)9 98061585', '', '07:00', 'segunda-quarta-sexta7', '18/08/2015', '', '', '', 'Sim', 'Sim', ' ', ' ', ' ', 'Problemas de Coluna', 'Hidroginástica', 'Dor Articular', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', 'Terapêutico', 'Manhã', ''),
(16, 'Ana Rute de Carvalho Matos', 'Tv. Filismino Filho 1142', '09/05/1986', 'Várzea da Matriz', '(88)9 96370820/9 93078485', '', '15:00', 'segunda-quarta-sexta', '18/01/2016', '49', '1.56', '29', 'Não', 'Não', ' ', ' ', ' ', 'Problemas de Coluna', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Selecione', ''),
(18, 'Edilene Campos Sombra Maia', 'Tv. Coronel Valente  104', '15/05/1985', 'Várzea da Matriz', '(88) 9 99437822', '', '15:00', 'segunda-quarta-sexta', '25/01/2016', '64', '', '30', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Selecione', ''),
(19, 'Euride Coelho Gomes Carvalho', 'Tv. Filismino FIlho ', '25/10/1962', 'Várzea da Matriz ', '(88)9 99639483', '', '15:00', 'segunda-quart-sexta', '18/01/2016', '', '', '', 'Não', 'Não', 'Diabetes', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Selecione', ''),
(20, 'Francisco Hermogenes', '', '  /  /    ', '', '', '', '15:00', 'segunda-quarta-sexta', '  /  /    ', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', ' ', 'Selecione', ''),
(22, 'José Cleudes Damasceno', 'Rua Beni Carvalho 1216', '07/02/1944', 'Nossa Senhora de Lourde', '(88)3421-3188', '', '15:00', 'segunda-quarta-sexta', '19/02/2016', '', '', '', 'Não', 'Não', 'Diabetes', ' ', ' ', ' ', 'Hidroginástica', 'Dor Articular', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', 'Terapêutico', 'Tarde', ''),
(23, 'José Correia da Silva ', 'Praça Marechal Deodoro 53', '05/04/1956', 'N.Senhora de Fátima ', '(8809 96685924', '', '15:00', 'segunda-quarta-sexta', '25/01/2016', '92', '', '', 'Sim', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Tem Prótese ou Órteses', '', ' ', ' ', ' ', 'Terapêutico', 'Tarde', ''),
(24, 'Lúcia Pinto Monteiro', 'Coronel Alexandrino 57', '13/04/1957', 'Centro', '(88)9 6008657', '', '15:00', 'segunda-quarta-sexta', '21/01/2016', '', '', '63', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Tarde', ''),
(25, 'Nair Gurgel Pinto Gondim', '', '25/01/1944', 'Centro', '(88)9 6933390', '', '15:00', 'segunda-quarta-sexta', '01/01/2016', '', '', '', 'Sim', 'Não', 'Diabetes', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Tem Prótese ou Órteses', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Tarde', ''),
(26, 'Neli Felix de Moura', 'Rua Dragão do Mar 720', '10/02/2016', 'Centro', '(88)9 99574652/ 3421-1718', '', '15:00', 'segunda-quarta-sexta', '17/02/2016', '72', '', '59', 'Sim', 'Não', 'Diabetes', ' ', ' ', 'Problemas de Coluna', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', 'Terapêutico', 'Selecione', ''),
(27, 'Pedro Rodrigues de Assis ', 'Tv. Visonde do Jaguaribe ', '15/08/1950', 'Varzéa da Matriz', '(88)9 99117450', '', '15:00', 'segunda-quarta-sexta', '05/01/2016', '', '', '66', 'Sim', 'Não', 'Diabetes', ' ', ' ', ' ', 'Hidroginástica', 'Dor Articular', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', 'Terapêutico', 'Tarde', ''),
(28, 'Rosa Ferreira ', 'Pedra Redonda ', '15/08/1950', '', '(88)9 94142655', '', '15:00', 'segunda-quarta-sexta', '18/02/2016', '', '', '', 'Sim', 'Não', ' ', ' ', 'Osteoporose', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Tarde', ''),
(29, 'Redna de Souza Barbosa Oliveira ', 'Coronel Alexandrino 37', '27/01/1984', 'Centro', '(85)97882621', '', '15:00', 'segunda-quarta-sexta', '23/02/2016', '108', '', '32', 'Sim', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', 'Terapêutico', 'Tarde', ''),
(30, 'Alexandra Maria Oliveira ', 'Rua São Judas Tadeu ', '01/04/1981', 'Fátima', '(88)9 97031588', '', '17:00', 'segunda-quarta-sexta', '09/09/2016', '', '', '35', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Tarde', ''),
(31, 'Lùcia de Fátima Lobo Costa Lima ', 'Santos Dumont  214', '31/12/1955', 'Centro', '', '', '17:00', 'segunda-quarta-sexta', '04/09/2016', '', '', '57', 'Não', 'Não', 'Diabetes', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', 'Alergia', 'Tem Prótese ou Órteses', '', ' ', ' ', ' ', 'Terapêutico', 'Tarde', ''),
(32, 'Lenise Lima dos Santos ', 'Rua Bonito 110', '14/02/1969', 'Peregal', '', '', '17:00', 'segunda-quarta-sexta ', '01/06/2016', '80', '47', '47', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Tarde', ''),
(33, 'Maria Tereza Texeira de Sousa', 'Tv. Beni Carvalho 57', '02/04/1953', 'José de Alencar ', '(88)9 97003370/ 999240377', '', '17:00', 'segunda-quarta-sexta', '04/01/2016', '', '', '63', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Tarde', ''),
(34, 'Maria Izolda Castro da Silva ', 'Rua Joaquim Ponciano 807', '12/05/1960', 'Centro', '(88)9 94001156', '', '17:00', 'segunda-quarta-sexta', '04/01/2016', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Tarde', ''),
(35, ' Marineide Sousa Lima', 'Rua Gustavo Pereira do Nascimento 213', '31/03/1964', 'Campo São Francisco ', '(88)9 94907605', '', '17:00', 'segunda-quarta-sexta', '12/02/2016', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Tarde', ''),
(36, 'Maria Teobaldo Hipolito', 'Alexandre Lima 847', '27/02/1936', '', '(88)9 99496572', '', '17:00', 'segunda-quarta-sexta', '04/01/2016', '', '', '', 'Sim', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', 'Terapêutico', 'Tarde', ''),
(38, 'Regis Teobaldo Hipoloto', '', '  /  /    ', '', '', '', '17:00', 'segunda-quarta-sexta', '  /  /    ', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', ' ', 'Selecione', ''),
(39, 'Josete Soares da Silva', 'Tv. Treze de Maio ', '10/03/1970', '', '(88)9 88078266', '', '17:00', 'segunda-quarta-sexta', '25/01/2013', '', '', '45', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Tarde', ''),
(40, 'Geraldina Castro da Silva', 'Rua Ricardo Dias da Silva Nunes de Deus ', '22/10/1949', '', '(88)9 96049017', '', '17:00', 'segunda-quarta-sexta', '07/03/2016', '', '', '65', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', 'Dor Articular', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Artrose ', ' ', ' ', ' ', 'Terapêutico', 'Tarde', ''),
(41, 'Herica de Oliveira Silva', 'Rua Grande 196', '05/04/1938', '', '(88)9 96067838', '', '17:00', 'segunda-quarta-sexta', '07/03/2016', '', '', '', 'Não', 'Não', ' ', ' ', ' ', 'Problemas de Coluna', 'Hidroginástica', 'Dor Articular', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'hernia de disco', 'Condicionamento Físico', ' ', ' ', 'Terapêutico', 'Tarde', ''),
(42, 'José Lourenço da Costa ', 'Tv. Treze de Maio', '03/08/1960', '', '', '', '17:00', 'segunda-quarta-sexta', '07/03/2016', '', '', '56', 'Sim', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'AVC', 'Condicionamento Físico', ' ', ' ', 'Terapêutico', 'Tarde', ''),
(43, 'Maria Correia de Melo', '', '  /  /    ', '', '', '', '07:00', 'segunda-quarta-sexta', '  /  /    ', '', '', '', 'Sim', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', ' ', 'Manhã', ''),
(44, 'Gracilda Ferreira da Silva', 'Tv. Filismino Filho 1182', '19/01/1954', 'Varzea da Matriz', '(88)9 96408444', '', '07:00', 'segunda-quarta-sexta', '01/03/2016', '', '', '62', 'Não', 'Não', ' ', ' ', ' ', 'Problemas de Coluna', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', 'Terapêutico', 'Manhã', ''),
(45, 'Lucenir Loureiro ', 'Marjorlandia', '19/01/1954', '', '(88)9 96673662', '', '07:00', 'Segunda-quarta-sexta', '01/03/2016', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Manhã', ''),
(46, 'Maria Lindalva Cornelio da Silva', 'Furquilha', '00/00/0000', '', '(88)9 996931508', '', '07:00', 'diaria', '10/11/2015', '', '', '', 'Sim', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Manhã', ''),
(47, 'Gerlândia da Silva Freire', 'Tv. Salgado Filho ', '  /  /    ', 'Várzea da Matriz', '', '', '18:00', 'segunda-quarta-sexta', '07/03/2016', '63', '', '29', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Gestante', 'Condicionamento Físico', ' ', ' ', 'Terapêutico', 'Noite', ''),
(49, 'Maria de Fátima da Silva Costa', '', '  /  /    ', '', '', '', '18:00', 'segunda-quarta-sexta', '  /  /    ', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', ' ', 'Noite', ''),
(50, 'João Ribeiro da Costa ', 'Agapito dos Santos', '16/01/2016', 'Centro', '(88)9 99288471', '', '18:00', 'segunda-quarta-sexta', '07/03/2016', '', '', '', 'Sim', 'Sim', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Noite', ''),
(51, 'Waldir Cr. da Silva Filho ', 'Duque de Caxias 287', '18/01/1961', 'Centro', '(8803421-2330', '', '18:00', 'segunda-quarta-sexta', '  /  /    ', '109', '1.78', '54', 'Sim', 'Não', 'Diabetes', ' ', ' ', ' ', ' ', 'Dor Articular', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Noite', ''),
(52, 'Andreia Fernandes Alburquerque', 'Duque de Caxias', '11/03/1970', 'Centro', '', '', '18:00', 'segunda-quarta-sexta', '  /  /    ', '70', '', '46', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Noite', ''),
(53, 'Maria josecilia Virginia da Costa', 'Tv. Filismino Filho 1073', '11/03/1970', 'várzea da Matriz', '(88)9 96994950', '', '18:00', 'segunda-quarta-sexta', '04/03/2016', '67,100', '1.72', '', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', 'Dor Articular', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Noite', ''),
(54, 'Maria Alice Filha ', 'Rua José Freire do Nascimento', '17/02/2016', 'Várzea da Matriz', '', '', '19:00', 'segunda-quarta-sexta', '24/02/2016', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Noite', ''),
(55, 'Nádia Isabelle Alves da Silva ', 'Dois de Novembro 1231', '07/11/1984', 'Varzéa da Matriz', '', '', '19:00', 'segunda-quarta-sexta', '15/02/2016', '', '', '30', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Noite', ''),
(56, 'Neuzelinda Maria ', 'Rua Salgado Filho ', '19/01/1968', '', '(88)9 99134554', '', '19:00', 'segunda-quarta-sexta', '20/04/2015', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Noite', ''),
(57, 'Ivonete Monteiro dos Santos', 'Santos Dumont 08', '04/06/1981', 'Centro', '', '', '19:00', 'segunda-quarta-sexta', '11/01/2016', '70', '1,56', '34', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', 'Dor Articular', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Noite', ''),
(58, 'Maria das Dores de Souza Dourado', 'Carolina Pereira dos Santos 136', '04/06/1981', 'Coluna ', '', '', '19:00', 'segunda-quarta-sexta', '11/01/2016', '', '', '53', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', 'Dor Articular', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Noite', ''),
(59, 'Maria de Lourdes Nascimento da Conceição', 'Tv. Francisco Saboia 439', '15/02/1936', '', '', '', '19:00', 'segunda-quarta-sexta', '22/01/2016', '', '', '', 'Sim', 'Não', ' ', ' ', ' ', 'Problemas de Coluna', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Noite', ''),
(60, 'José Enecino da Silva ', 'Coronel Pompeu 188', '15/02/1936', 'Centro', '(88)9 96456020', '', '19:00', 'segunda-quarta-sexta', '04/05/2015', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Noite', ''),
(61, 'João josé de Lima Silva ', 'Filismini Filho 109', '16/07/1966', 'Varzea da Matriz', '', '', '19:00', 'segunda-quarta-sexta', '12/02/2016', '', '', '48', 'Sim', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'AVC', ' ', ' ', ' ', 'Terapêutico', 'Noite', ''),
(62, 'Geralda Nogueira Oliveira', 'Tv. Filismino Filho ', '21/09/1953', 'Fátima', '', '', '19:00', 'segunda-quarta-sexta', '01/03/2016', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Noite', ''),
(63, 'Roberto Carlos de Sousa Gondim ', 'Antônio Calisto 1225', '09/09/1966', '', '(88)92428570', '', '19:00', 'segunda-quarta-sexta', '15/04/2015', '88', '', '48', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', 'Terapêutico', 'Noite', ''),
(65, 'Franqueline Barros de Moura', 'Rua de Paz', '14/12/1987', 'Várzea da Matriz', '', '', '19:00', 'segunda-quarta-sexta', '11/03/2016', '79,600', '', '35', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Noite', ''),
(66, 'Maria Beningma Lima do Nascimento', 'Rua Joaquim Ponciano 955', '26/06/1945', '', '', '', '07:00', 'segunda-quarta-sexta', '01/03/2016', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', 'Problemas Neurológicos', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', 'Terapêutico', 'Manhã', ''),
(68, 'Marlene Arrúda de Oliveira', 'Gustavo Perreira do Nascimento ', '28/03/1964', 'Fátima ', '', '', '07:00', 'segunda-quarta-sexta', '15/03/2016', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Manhã', ''),
(69, 'Maria Isabel Soares ', 'Gustavo Pereira do Nascimento ', '04/07/1948', 'Fátima ', '', '', '17:00', 'segunda-quarta-sexta', '09/03/2016', '', '', '', 'Sim', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', 'Dor Articular', ' ', ' ', ' ', ' ', ' ', ' ', 'Tem Prótese ou Órteses', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Tarde', ''),
(70, 'Lidiane Silva da Costa', 'Agapito dos Santos 384', '26/08/1981', '', '', '', '17:00', 'segunda-quarta', '15/03/2016', '', '', '', 'Não', 'Não', ' ', ' ', ' ', 'Problemas de Coluna', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Tarde', ''),
(71, 'Nadja Maria Melo Lima ', 'Rua Duque de Caxias 309', '17/03/1962', '', '', '', '17:00', 'segunda-quarta-sexta', '16/03/2016', '', '', '', 'Não', 'Não', ' ', ' ', ' ', 'Problemas de Coluna', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', ' ', 'Selecione', ''),
(72, 'Isabel Cristina Barros da Costa ', 'Rua Rui Barbosa 329', '  /  /    ', 'Centro ', '', '', '17:00', 'segunda-quarta-sexta', '13/03/2016', '66', '158', '58', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', 'Alergia', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Tarde', ''),
(73, 'Maria Lucia Moura da Silva ', 'Visconde Jagurube 1453', '15/05/1965', 'Várzea da Matrizz', '', '', '07:00', 'segunda-terça-quarta', '21/03/2016', '', '', '50', 'Não', 'Não', ' ', ' ', ' ', 'Problemas de Coluna', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Selecione', ''),
(74, 'Audeide Bezerra Braga', 'Agapito dos Santos 96', '13/03/1972', 'Centro', '', '', '18:00', 'segunda-quarta-sexta ', '04/03/2016', '65', '', '44', 'Não', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Noite', ''),
(75, 'Maria Zilma da Rocha ', '', '  /  /    ', '', '', '', '07:00', 'segunda-quarta-sexta', '  /  /    ', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', ' ', 'Manhã', ''),
(76, 'Alana Sousa Cavalcante ', 'Tabua Lascada ', '18/11/2008', '', '', '', '08:00', 'terça-quinta', '21/10/2015', '22', '', '7 anos', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', ' ', ' ', 'Aprendizagem', ' ', 'Manhã', ''),
(77, 'Ana Clara dos Santos Barros ', 'Vila Rafael rua c n-4031', '03/08/2005', 'v. da Matriz', '(88)9 965844/   9 98455768', '', '08:00', 'terça-quinta', '12/01/2016', '', '', '10 anos', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', ' ', ' ', 'Aprendizagem', ' ', 'Manhã', ''),
(78, 'André Lucas Monteiro Silveira ', 'Rui Barbosa 395', '19/10/2008', '', '', '', '08:00', 'terça-quinta', '11/02/2016', '', '', '7 anos ', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', 'Aprendizagem', ' ', 'Manhã', ''),
(79, 'Ana Beatriz dos Santos Silva ', 'Rua dos Franceses', '08/10/2008', 'Nossa S. de Lourdes ', '(88)9 97161009', '', '08:00', 'terça-quinta', '16/06/2015', '', '', '7 anos', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', ' ', ' ', 'Aprendizagem', ' ', 'Manhã', ''),
(80, 'Maria Ivy da Silva Santos', '', '  /  /    ', '', '', '', '08:00', 'terça-quinta', '08/03/2016', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', ' ', 'Selecione', ''),
(81, 'Marcos Vinicius Barros Fernandes ', 'Rua São Pedro 1349', '19/08/2005', 'Varzéa da Matriz ', '', '', '08:00', 'terça-quinta ', '06/10/2015', '', '', '8 anos ', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', ' ', ' ', 'Aprendizagem', ' ', 'Manhã', ''),
(82, 'Loizi Eulália Costa Goiabeira ', 'Lagos do junco ', '23/06/2007', 'Giral', '(88)9 96800743/  9 92342052', '', '08:00', 'terça-quinta ', '03/09/2015', '', '', '8 anos ', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', ' ', ' ', 'Aprendizagem', ' ', 'Manhã', ''),
(83, 'Lucas Glicerio Tiné ', 'Agapito dos Santos ', '07/12/2009', 'Centro ', '', '', '08:00', 'terça-quinta ', '16/02/2016', '22', '', '6 anos ', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', ' ', ' ', 'Aprendizagem', ' ', 'Manhã', ''),
(84, 'Sandryellen Paula da Silva ', '', '  /  /    ', '', '(88)9 96601862', '', '08:00', 'terça-quinta', '  /  /    ', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', ' ', 'Selecione', ''),
(85, 'Yegor Lira da Costa Moreira ', 'TV. São josé ', '12/11/2008', '', '(88)9 96677768/ 9 94773865', '', '08:00', 'terça-quinta ', '23/06/2015', '', '', '6 anos ', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', ' ', ' ', 'Aprendizagem', ' ', 'Manhã', ''),
(90, 'José de Lima Filho ', 'Rua Duque de Caxias   329', '07/04/1961', '', '(88)9 96456429', '', '07:00', 'segunda-quarta-sexta', '01/04/2016', '', '', '55', 'Sim', 'Não', ' ', ' ', ' ', ' ', 'Hidroginástica', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Manhã', ''),
(91, 'Sabrina da Silva Oliveira ', 'Tv. Dois de Novembro ', '22/06/2005', 'Fátima ', '', '', '09:00', 'terça-quinta', '29/03/2016', '', '', '10 anos ', 'Sim', 'Não', ' ', ' ', ' ', 'Problemas de Coluna', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', ' ', ' ', ' ', 'Terapêutico', 'Manhã', ''),
(92, 'Cecília Catarina L. Tavares ', 'Santos Dumont   663', '13/12/2008', 'Centro', '(88)9 97263226', '', '09:00', 'terça-quinta', '05/01/2016', '', '', '8 anos', 'Sim', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', ' ', ' ', 'Manhã', ''),
(93, 'Aryston Fernandes de Oliveira ', 'Rua Catarina Pinto  1586 ', '27/10/2003', '', '', '', '09:00', 'terça-quinta', '08/03/2016', '', '', '12 anos', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', 'Aprendizagem', ' ', 'Manhã', ''),
(94, 'Ariadne Silva Ferreira ', '', '  /  /    ', 'V. da Matriz', '', '', '08:00', 'terça-quinta', '  /  /    ', '', '', '7 anos ', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', ' ', 'Selecione', ''),
(95, 'Matheus Meier Mesina ', '', '  /  /    ', '', '', '', '09:00', 'terça-quinta ', '  /  /    ', '', '', '', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '', ' ', ' ', ' ', ' ', 'Manhã', ''),
(96, 'Maria Clara Jathai', 'Coronel Alexanzito 137', '26/07/2009', 'Centro', '(88) 9 97809565', '', '09:00', 'terça-quinta', '06/01/2016', '', '', '6 anos ', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', 'Condicionamento Físico', ' ', 'Aprendizagem', ' ', 'Manhã', ''),
(97, 'Maria Isabel Pinheiro Mendonça Silva ', 'Rua Filismino Filho 1270', '26/07/2009', 'Varzea da Matriz ', '(88)9 9754503/   9 96711363', '', '09:00', 'quarta-sexta ', '08/06/2015', '', '', '7 anos ', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', ' ', ' ', 'Aprendizagem', ' ', 'Manhã', ''),
(98, 'Isabelle Pimentel Rebouças ', 'Cohab 101', '21/02/2011', 'Cohabe', '(88)9 93335162', '', '09:00', 'quarta-sexta', '09/03/2016', '20.800', '', '5 anos ', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', ' ', ' ', 'Aprendizagem', ' ', 'Manhã', ''),
(99, 'Luana Emilly Carneiro Pimentel', 'Cohab 122', '14/07/1991', 'Cohab', '(88)34216952/ 9 93108077', '', '09:00', 'quarta-sexta', '09/03/2016', '', '', '24', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', ' ', ' ', ' ', 'Terapêutico', 'Manhã', ''),
(100, 'Ana Vitória da Silva ', 'Conjunto Tabajara Rua b18', '30/09/2008', '', '(88)9 96505807pai', '', '09:00', 'quarta-sexta ', '01/03/2016', '', '', '8 anos ', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', ' ', ' ', 'Aprendizagem', ' ', 'Manhã', ''),
(101, 'Nathanael Andrade de Freitas ', 'Filismino Filho ', '05/04/2010', 'Fátima ', '', '', '09:00', 'quarta-sexta ', '15/01/2016', '21', '', '5 anoa ', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', '', ' ', ' ', 'Aprendizagem', ' ', 'Manhã', ''),
(102, 'Leonardo Nunes Sipriano ', 'Rua Irmã Nubia Alves Dias ', '20/09/2011', '', '(88)3421-2633', '', '09:00', 'quarta-sexta ', '05/01/2016', '', '', '5 anos', 'Não', 'Não', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Natação', ' ', ' ', ' ', 'imperativo ', ' ', ' ', 'Aprendizagem', ' ', 'Manhã', '');
...
CREATE TABLE IF NOT EXISTS `frequencia` (
  ...
  `turma` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `frequencia` (`codigo`, `nome`, `dia`, `mes`, `ano`, `status`, `turno`, `turma`, `observacao`) VALUES
(2, 'Josefa Araújo de Oliveira', '28', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(3, 'Iolanda Eduarda da Costa ', '28', 'Março', '2016', 'Falta', 'Manhã', '', NULL),
(4, 'Maria da Penha de Castro', '28', 'Março', '2016', 'Falta', 'Manhã', '', NULL),
(5, 'Maria José de Oliveira', '28', 'Março', '2016', 'Falta', 'Manhã', '', NULL),
(6, 'Marluce Silva Santos', '28', 'Março', '2016', 'Falta', 'Manhã', '', NULL),
(7, 'Conceição de Maria Giló Lima ', '02', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(8, 'Conceição de Maria Giló Lima ', '03', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(9, 'Conceição de Maria Giló Lima ', '07', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(10, 'Conceição de Maria Giló Lima ', '08', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(11, 'Conceição de Maria Giló Lima ', '09', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(12, 'Conceição de Maria Giló Lima ', '11', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(13, 'Conceição de Maria Giló Lima ', '14', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(14, 'Conceição de Maria Giló Lima ', '16', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(15, 'Conceição de Maria Giló Lima ', '17', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(16, 'Conceição de Maria Giló Lima ', '18', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(17, 'Conceição de Maria Giló Lima ', '21', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(18, 'Conceição de Maria Giló Lima ', '23', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(19, 'Conceição de Maria Giló Lima ', '28', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(20, 'Conceição de Maria Giló Lima ', '29', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(21, 'Conceição de Maria Giló Lima ', '30', 'Março', '2016', 'Presente', 'Manhã', '', NULL),
(22, 'Conceição de Maria Giló Lima ', '31', 'Março', '2016', 'Presente', 'Manhã', '', NULL);
...
INSERT INTO `funcionario` (`id`, `login`, `senha`) VALUES
(1, 'hidromania', '123456');
...
CREATE TABLE IF NOT EXISTS `orcamento` (
  ...
  `dia` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mes` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pagamento` (
  ...
  `valor` double NOT NULL,
  `DataVencimento` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `turma` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `observacao` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`codigo`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=2 ;
...
INSERT INTO `pagamento` (`codigo`, `nome`, `dia`, `mes`, `ano`, `valor`, `DataVencimento`, `turma`, `observacao`) VALUES
(1, 'Conceição de Maria Giló Lima ', '', 'Janeiro', '2016', 65, '  /  /    ', '', NULL);

-- --------------------------------------------------------

--
-- Estrutura da tabela `pagamentopilates`
--

CREATE TABLE IF NOT EXISTS `pagamentopilates` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `valor` double NOT NULL,
  `DataVencimento` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `observacao` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `horario` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=4 ;

--
-- Extraindo dados da tabela `pagamentopilates`
--

INSERT INTO `pagamentopilates` (`id`, `nome`, `dia`, `mes`, `ano`, `valor`, `DataVencimento`, `observacao`, `horario`) VALUES
(1, 'Diana Piva ', '04', 'Abril', '2016', 140, '04/04/2016', NULL, ''),
(2, 'Lidia Farias Lima', '05', 'Abril', '2016', 140, '05/04/2016', NULL, ''),
(3, 'Manuel Luiz da Silva ', '06', 'Abril', '2016', 110, '06/04/2016', NULL, '');

-- --------------------------------------------------------

--
-- Estrutura da tabela `pilates`
--
...
--
-- Extraindo dados da tabela `pilates`
--

INSERT INTO `pilates` (`id`, `nome`, `telefone`, `horario`, `inicio`, `dataNasc`, `dias`) VALUES
(1, 'Diana Piva ', '(88)99937-5627', '18:00 ás 19:00', '04/04/2016', '01/03/1989', 'terça-quinta'),
(2, 'Lidia Farias Lima', '(85)98843-1893', '18:00 ás 19:00', '05/04/2016', '08/07/1988', 'terça=quinta'),
(3, 'Manuel Luiz da Silva ', '(88)99220-0555', '08:00 ás 09:00', '06/04/2016', '26/05/1979', 'segunda-quarta');
--
...
('def', 'gissa', 'paciente', 'idPaciente', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'gissa', 'paciente', 'Nome', 2, NULL, 'NO', 'varchar', 100, 400, NULL, NULL, 'utf8mb4', 'utf8mb4_bin', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'gissa', 'paciente', 'idade', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'gissa', 'paciente', 'altura', 4, NULL, 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'gissa', 'paciente', 'peso', 5, NULL, 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'adm', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'hidromania', 'adm', 'login', 2, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'adm', 'senha', 3, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'nome', 2, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'endereco', 3, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'datanascimento', 4, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'bairro', 5, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'fone', 6, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'email', 7, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'hora', 8, NULL, 'YES', 'varchar', 5, 5, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(5)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'dias', 9, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'inicio', 10, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'peso', 11, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'altura', 12, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'idade', 13, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'hipertensao', 14, NULL, 'YES', 'varchar', 3, 3, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(3)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'Exercitando', 15, NULL, 'YES', 'varchar', 5, 5, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(5)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'diabetes', 16, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'asma', 17, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'osteoporose', 18, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'problemascoluna', 19, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'hidroginastica', 20, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'dorarticular', 21, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'problemascardiacos', 22, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'artrite', 23, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'problemasneurologicos', 24, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'natacao', 25, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'implantesmetalicos', 26, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'alergia', 27, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'proteseouortese', 28, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'outros', 29, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'condicionamentofisico', 30, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'lazer', 31, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'aprendizagem', 32, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'terapeutico', 33, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'turno', 34, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'clientes', 'turma', 35, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'frequencia', 'codigo', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'hidromania', 'frequencia', 'nome', 2, NULL, 'NO', 'varchar', 100, 400, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'frequencia', 'dia', 3, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'frequencia', 'mes', 4, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'frequencia', 'ano', 5, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'frequencia', 'status', 6, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'frequencia', 'turno', 7, NULL, 'NO', 'varchar', 10, 40, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'frequencia', 'turma', 8, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'frequencia', 'observacao', 9, NULL, 'YES', 'varchar', 100, 400, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'funcionario', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'hidromania', 'funcionario', 'login', 2, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'funcionario', 'senha', 3, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'orcamento', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'hidromania', 'orcamento', 'produto_servico', 2, NULL, 'NO', 'varchar', 200, 800, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'orcamento', 'dia', 3, NULL, 'NO', 'varchar', 3, 12, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(3)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'orcamento', 'mes', 4, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'orcamento', 'ano', 5, NULL, 'NO', 'varchar', 5, 20, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(5)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'orcamento', 'quantidade', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'orcamento', 'valor', 7, NULL, 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamento', 'codigo', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamento', 'nome', 2, NULL, 'NO', 'varchar', 100, 400, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamento', 'dia', 3, NULL, 'NO', 'varchar', 10, 40, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamento', 'mes', 4, NULL, 'NO', 'varchar', 10, 40, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamento', 'ano', 5, NULL, 'NO', 'varchar', 10, 40, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamento', 'valor', 6, NULL, 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamento', 'DataVencimento', 7, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamento', 'turma', 8, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamento', 'observacao', 9, NULL, 'YES', 'varchar', 100, 400, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamentopilates', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamentopilates', 'nome', 2, NULL, 'NO', 'varchar', 200, 800, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamentopilates', 'dia', 3, NULL, 'NO', 'varchar', 3, 12, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(3)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamentopilates', 'mes', 4, NULL, 'NO', 'varchar', 10, 40, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamentopilates', 'ano', 5, NULL, 'NO', 'varchar', 5, 20, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(5)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamentopilates', 'valor', 6, NULL, 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamentopilates', 'DataVencimento', 7, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamentopilates', 'observacao', 8, NULL, 'YES', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pagamentopilates', 'horario', 9, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pilates', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'hidromania', 'pilates', 'nome', 2, NULL, 'NO', 'varchar', 100, 400, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pilates', 'telefone', 3, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pilates', 'horario', 4, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pilates', 'inicio', 5, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pilates', 'dataNasc', 6, NULL, 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'hidromania', 'pilates', 'dias', 7, NULL, 'NO', 'varchar', 100, 400, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
...
('def', 'petshop', 'agendamento', 'idcliente', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'petshop', 'agendamento', 'nomecliente', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'agendamento', 'data', 3, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'agendamento', 'tipo', 4, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'anamnese', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'petshop', 'anamnese', 'NomeCliente', 2, NULL, 'NO', 'varchar', 60, 60, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(60)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'anamnese', 'QueixaPrincipal', 3, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'anamnese', 'Historico', 4, NULL, 'YES', 'varchar', 600, 600, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(600)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'anamnese', 'Vacinacao', 5, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'anamnese', 'vermifugacao', 6, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'anamnese', 'Alimentacao', 7, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'anamnese', 'DoencasAnteriores', 8, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'anamnese', 'Ambiente', 9, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'anamnese', 'Contactantes', 10, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'anamnese', 'MedicacaoUtilizada', 11, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'animal', 'idAnimal', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'petshop', 'animal', 'nome', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'animal', 'sexo', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'animal', 'data_nasc', 4, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'animal', 'peso', 5, NULL, 'NO', 'varchar', 5, 5, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(5)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
('def', 'petshop', 'animal', 'especie', 6, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'animal', 'raca', 7, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'animal', 'cor', 8, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'animal', 'vacinas', 9, NULL, 'NO', 'varchar', 80, 80, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'animal', 'informacoes', 10, NULL, 'NO', 'varchar', 999, 999, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(999)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'animal', 'dataRegistro', 11, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'animal', 'NomeDono', 12, NULL, 'NO', 'varchar', 60, 60, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(60)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'NomeCliente', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'EstadoGeral', 3, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Temp', 4, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Hidratacao', 5, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Linfonodos', 6, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'FC', 7, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Pulso', 8, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'FR', 9, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Mucosas', 10, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Olhos', 11, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Orelhas', 12, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Ectoparasitas', 13, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Pele', 14, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Cardiovascular', 15, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Respiratorio', 16, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Digestorio', 17, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Reprodutivo', 18, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Neurologico', 19, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Urinario', 20, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'DiagnosticoProvavel', 21, NULL, 'NO', 'varchar', 600, 600, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(600)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'ExamesComplementares', 22, NULL, 'NO', 'varchar', 500, 500, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(500)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'ResultadoExames', 23, NULL, 'NO', 'varchar', 500, 500, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(500)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'DiagnosticoDefinitivo', 24, NULL, 'NO', 'varchar', 500, 500, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(500)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Prognosticos', 25, NULL, 'NO', 'varchar', 500, 500, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(500)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Tratamento', 26, NULL, 'NO', 'varchar', 500, 500, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(500)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'avalicao', 'Retornos', 27, NULL, 'NO', 'varchar', 500, 500, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(500)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'cliente', 'idcliente', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'petshop', 'cliente', 'nome', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'cliente', 'endereco', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'cliente', 'sexo', 4, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'cliente', 'bairro', 5, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'cliente', 'cidade', 6, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'cliente', 'uf', 7, NULL, 'NO', 'char', 2, 2, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(2)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'cliente', 'cep', 8, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'cliente', 'operadora', 9, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'cliente', 'celular', 10, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'cliente', 'telefone', 11, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'cliente', 'email', 12, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'cliente', 'rg', 13, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'cliente', 'cpf', 14, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'cliente', 'data_nasc', 15, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'debito', 'idcliente', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'debito', 'nome', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'debito', 'valor', 3, NULL, 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'diavacina', 'idcliente', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'petshop', 'diavacina', 'nomecliente', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'diavacina', 'animal', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'diavacina', 'data', 4, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'diavacina', 'hora', 5, NULL, 'NO', 'varchar', 5, 5, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(5)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'diavacina', 'status', 6, NULL, 'NO', 'varchar', 1000, 1000, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(1000)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'estoque', 'idproduto', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'petshop', 'estoque', 'produto', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'estoque', 'quantidade', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'estoque', 'preco', 4, NULL, 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'estoque', 'datacompra', 5, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'estoque', 'datavalidade', 6, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'funcionario', 'idfuncionario', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'petshop', 'funcionario', 'nome', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'funcionario', 'endereco', 3, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'funcionario', 'sexo', 4, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'funcionario', 'cidade', 5, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'funcionario', 'bairro', 6, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'funcionario', 'uf', 7, NULL, 'NO', 'char', 2, 2, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(2)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'funcionario', 'celular', 8, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'funcionario', 'cpf', 9, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'funcionario', 'rg', 10, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'funcionario', 'cep', 11, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'funcionario', 'email', 12, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'funcionario', 'data_nasc', 13, NULL, 'NO', 'varchar', 11, 11, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(11)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'funcionario', 'funcao', 14, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'gasto', 'idgasto', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'petshop', 'gasto', 'produto', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'gasto', 'quantidade', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'gasto', 'preco', 4, NULL, 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'gasto', 'dia', 5, NULL, 'NO', 'varchar', 3, 3, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(3)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'gasto', 'mes', 6, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'gasto', 'ano', 7, NULL, 'NO', 'varchar', 6, 6, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(6)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'historico', 'idHistorico', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'petshop', 'historico', 'idcliente', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'historico', 'nomecliente', 3, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'historico', 'data', 4, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'historico', 'servico', 5, NULL, 'NO', 'varchar', 10000, 10000, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10000)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'login', 'idUsuario', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'petshop', 'login', 'usuario', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'login', 'senha', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'receita', 'idreceita', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'petshop', 'receita', 'cliente', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'receita', 'animal', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'receita', 'receita', 4, NULL, 'NO', 'varchar', 2000, 2000, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(2000)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'receita', 'sintomas', 5, NULL, 'NO', 'varchar', 2000, 2000, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(2000)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'receita', 'observacao', 6, NULL, 'NO', 'varchar', 2000, 2000, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(2000)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'idtosa', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'nome_animal', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'nome_dono', 3, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'raca', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'horario_chegada', 5, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'horario_entregue', 6, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'banho', 7, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'deixou_guia', 8, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'tosa', 9, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'retirada_de_pelo', 10, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'presença_de_parasitas', 11, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'encaminhamento', 12, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'lesoes_pele', 13, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'quais', 14, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'secrecao_ouvido', 15, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'coloracao', 16, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'obs', 17, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'obsBanho', 18, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'obsTosa', 19, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'Tosador', 20, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'Banhista', 21, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'tosa', 'data', 22, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'idvenda', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'idcliente', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'cliente', 3, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'produto', 4, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'quatidade', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'codproduto', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'preco', 7, NULL, 'YES', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'dia', 8, NULL, 'YES', 'varchar', 2, 2, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(2)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'mes', 9, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'ano', 10, NULL, 'YES', 'varchar', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(4)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'totalvenda', 11, '0', 'YES', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'totalservico', 12, '0', 'YES', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'tiposervico', 13, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'vezes', 14, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'cartao', 15, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'petshop', 'vendas', 'status', 16, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'alimentos', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'restaurante', 'alimentos', 'nome', 2, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'alimentos', 'preco', 3, NULL, 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarfuncionario', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarfuncionario', 'sexo', 2, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarfuncionario', 'nome', 3, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarfuncionario', 'rg', 4, NULL, 'NO', 'varchar', 14, 42, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(14)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarfuncionario', 'cpf', 5, NULL, 'NO', 'varchar', 14, 42, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(14)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarfuncionario', 'telefone', 6, NULL, 'NO', 'varchar', 14, 42, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(14)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarfuncionario', 'data_nasc', 7, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarfuncionario', 'rua', 8, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarfuncionario', 'bairro', 9, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarfuncionario', 'cep', 10, NULL, 'NO', 'varchar', 14, 42, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(14)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarfuncionario', 'email', 11, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarpedido', 'Id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarpedido', 'Mesa', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(4)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarpedido', 'CodPedido', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarpedido', 'pedido', 4, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarpedido', 'quantidade', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(3)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarpedido', 'preco', 6, NULL, 'YES', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarpedido', 'total', 7, NULL, 'YES', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarpedido', 'status', 8, NULL, 'YES', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'listarpedido', 'nome', 9, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'login', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'restaurante', 'login', 'usuario', 2, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'login', 'senha', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'totaldia', 'data', 1, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'restaurante', 'totaldia', 'valor', 2, NULL, 'NO', 'varchar', 1000, 1000, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(1000)', '', '', 'select,insert,update,references', '');
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '2'),
('HANDLER_READ_RND_NEXT', '5297'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '4838'),
('INNODB_BUFFER_POOL_PAGES_DATA', '249'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '28'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7942'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '2015'),
('INNODB_BUFFER_POOL_READS', '249'),
...
('INNODB_DATA_READ', '6262784'),
('INNODB_DATA_READS', '259'),
('INNODB_DATA_WRITES', '32'),
('INNODB_DATA_WRITTEN', '467968'),
('INNODB_DBLWR_PAGES_WRITTEN', '14'),
('INNODB_DBLWR_WRITES', '4'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '4'),
('INNODB_LOG_WRITES', '9'),
('INNODB_OS_LOG_FSYNCS', '14'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '6656'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '1'),
('INNODB_PAGES_READ', '248'),
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.20\\data\\ViniciusNunes.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.20\\data\\ViniciusNunes.log'),
('FLUSH_TIME', '1800'),
...
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.20\\data\\ViniciusNunes-slow.log'),
...
('def', 'gissa', 'PRIMARY', 'def', 'gissa', 'paciente', 'idPaciente', 1, NULL, NULL, NULL, NULL),
('def', 'hidromania', 'PRIMARY', 'def', 'hidromania', 'adm', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'hidromania', 'PRIMARY', 'def', 'hidromania', 'clientes', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'hidromania', 'PRIMARY', 'def', 'hidromania', 'frequencia', 'codigo', 1, NULL, NULL, NULL, NULL),
('def', 'hidromania', 'PRIMARY', 'def', 'hidromania', 'funcionario', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'hidromania', 'PRIMARY', 'def', 'hidromania', 'orcamento', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'hidromania', 'PRIMARY', 'def', 'hidromania', 'pagamento', 'codigo', 1, NULL, NULL, NULL, NULL),
('def', 'hidromania', 'PRIMARY', 'def', 'hidromania', 'pagamentopilates', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'hidromania', 'PRIMARY', 'def', 'hidromania', 'pilates', 'id', 1, NULL, NULL, NULL, NULL),
...
('def', 'petshop', 'PRIMARY', 'def', 'petshop', 'agendamento', 'idcliente', 1, NULL, NULL, NULL, NULL),
('def', 'petshop', 'PRIMARY', 'def', 'petshop', 'anamnese', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'petshop', 'PRIMARY', 'def', 'petshop', 'animal', 'idAnimal', 1, NULL, NULL, NULL, NULL),
('def', 'petshop', 'PRIMARY', 'def', 'petshop', 'avalicao', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'petshop', 'PRIMARY', 'def', 'petshop', 'cliente', 'idcliente', 1, NULL, NULL, NULL, NULL),
('def', 'petshop', 'PRIMARY', 'def', 'petshop', 'diavacina', 'idcliente', 1, NULL, NULL, NULL, NULL),
('def', 'petshop', 'PRIMARY', 'def', 'petshop', 'estoque', 'idproduto', 1, NULL, NULL, NULL, NULL),
('def', 'petshop', 'PRIMARY', 'def', 'petshop', 'funcionario', 'idfuncionario', 1, NULL, NULL, NULL, NULL),
('def', 'petshop', 'PRIMARY', 'def', 'petshop', 'gasto', 'idgasto', 1, NULL, NULL, NULL, NULL),
('def', 'petshop', 'PRIMARY', 'def', 'petshop', 'historico', 'idHistorico', 1, NULL, NULL, NULL, NULL),
('def', 'petshop', 'PRIMARY', 'def', 'petshop', 'login', 'idUsuario', 1, NULL, NULL, NULL, NULL),
('def', 'petshop', 'PRIMARY', 'def', 'petshop', 'receita', 'idreceita', 1, NULL, NULL, NULL, NULL),
('def', 'petshop', 'PRIMARY', 'def', 'petshop', 'tosa', 'idtosa', 1, NULL, NULL, NULL, NULL),
('def', 'restaurante', 'PRIMARY', 'def', 'restaurante', 'alimentos', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'restaurante', 'PRIMARY', 'def', 'restaurante', 'listarfuncionario', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'restaurante', 'PRIMARY', 'def', 'restaurante', 'listarpedido', 'Id', 1, NULL, NULL, NULL, NULL),
('def', 'restaurante', 'PRIMARY', 'def', 'restaurante', 'login', 'id', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-08-28 17:58:07', '2017-08-28 17:58:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-08-28 17:58:07', '2017-08-28 17:58:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-08-28 17:58:07', '2017-08-28 17:58:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-08-28 17:58:07', '2017-08-28 17:58:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-08-28 17:58:07', '2017-08-28 17:58:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-08-28 17:58:07', '2017-08-28 17:58:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-08-28 17:58:07', '2017-08-28 17:58:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-08-28 17:58:07', '2017-08-28 17:58:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-08-28 17:58:07', '2017-08-28 17:58:07', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2017-08-28 17:58:07', NULL, NULL, NULL, '', '', NULL),
('def', 'gissa', 'paciente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2017-06-27 14:04:23', NULL, NULL, NULL, '', '', NULL),
('def', 'hidromania', 'adm', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2017-06-27 14:32:11', NULL, NULL, NULL, '', '', NULL),
('def', 'hidromania', 'clientes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 65, 756, 49152, NULL, 0, 0, '2017-06-27 14:32:11', NULL, NULL, NULL, '', '', NULL),
('def', 'hidromania', 'frequencia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 21, 780, 16384, NULL, 0, 0, '2017-06-27 14:32:11', NULL, NULL, NULL, '', '', NULL),
('def', 'hidromania', 'funcionario', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2017-06-27 14:32:11', NULL, NULL, NULL, '', '', NULL),
('def', 'hidromania', 'orcamento', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2017-06-27 14:32:11', NULL, NULL, NULL, '', '', NULL),
('def', 'hidromania', 'pagamento', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2017-06-27 14:32:11', NULL, NULL, NULL, '', '', NULL),
('def', 'hidromania', 'pagamentopilates', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2017-06-27 14:32:12', NULL, NULL, NULL, '', '', NULL),
('def', 'hidromania', 'pilates', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2017-06-27 14:32:12', NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2011-12-16 21:03:08', '2012-01-25 11:47:18', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2011-12-16 21:03:08', '2012-01-25 11:47:18', '2011-12-16 21:03:09', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-16 21:03:09', '2012-01-25 11:47:18', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2011-12-16 21:03:08', '2012-01-25 11:47:18', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 465, 197, 91605, 55450570411999231, 16384, 0, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1028, 9, 9252, 2533274790395903, 19456, 0, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 867, 440716, 281474976710655, 20480, 0, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-12-16 21:03:09', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-16 21:03:09', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2011-12-16 21:03:09', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2011-12-16 21:03:09', '2012-01-25 11:47:20', '2011-12-16 21:03:09', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2011-12-16 21:03:09', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2011-12-16 21:03:09', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2011-12-16 21:03:09', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2011-12-16 21:03:09', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 53, 212, 281474976710655, 2048, 0, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, NULL, '', '', NULL),
...
('def', 'petshop', 'agendamento', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2017-07-07 13:17:54', NULL, NULL, NULL, '', '', NULL),
('def', 'petshop', 'anamnese', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 0, '2017-07-07 13:17:55', NULL, NULL, NULL, '', '', NULL),
('def', 'petshop', 'animal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 2730, 16384, NULL, 0, 0, '2017-07-07 13:17:55', NULL, NULL, NULL, '', '', NULL),
('def', 'petshop', 'avalicao', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2017-07-07 13:17:55', NULL, NULL, NULL, '', '', NULL),
('def', 'petshop', 'cliente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 0, 0, '2017-07-07 13:17:55', NULL, NULL, NULL, '', '', NULL),
('def', 'petshop', 'debito', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 18, 910, 16384, NULL, 0, 0, '2017-07-07 13:17:55', NULL, NULL, NULL, '', '', NULL),
('def', 'petshop', 'diavacina', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2017-07-07 13:17:55', NULL, NULL, NULL, '', '', NULL),
('def', 'petshop', 'estoque', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 0, 0, '2017-07-07 13:17:55', NULL, NULL, NULL, '', '', NULL),
('def', 'petshop', 'funcionario', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2017-07-07 13:17:55', NULL, NULL, NULL, '', '', NULL),
('def', 'petshop', 'gasto', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2017-07-07 13:17:55', NULL, NULL, NULL, '', '', NULL),
('def', 'petshop', 'historico', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2017-07-07 13:17:55', NULL, NULL, NULL, '', '', NULL),
('def', 'petshop', 'login', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2017-07-07 13:17:56', NULL, NULL, NULL, '', '', NULL),
('def', 'petshop', 'receita', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2017-07-07 13:17:56', NULL, NULL, NULL, '', '', NULL),
('def', 'petshop', 'tosa', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 0, '2017-07-07 13:17:56', NULL, NULL, NULL, '', '', NULL),
('def', 'petshop', 'vendas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 21, 780, 16384, NULL, 0, 0, '2017-07-07 13:17:56', NULL, NULL, NULL, '', '', NULL),
('def', 'restaurante', 'alimentos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 0, 0, '2017-07-07 13:17:16', NULL, NULL, NULL, '', '', NULL),
('def', 'restaurante', 'listarfuncionario', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2017-07-07 13:17:16', NULL, NULL, NULL, '', '', NULL),
('def', 'restaurante', 'listarpedido', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2017-07-07 13:17:16', NULL, NULL, NULL, '', '', NULL),
('def', 'restaurante', 'login', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2017-07-07 13:17:16', NULL, NULL, NULL, '', '', NULL),
('def', 'restaurante', 'totaldia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 0, 0, '2017-07-07 13:17:16', NULL, NULL, NULL, '', '', NULL);
...
(25, 'root', 'localhost:59448', 'hidromania', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'gissa', 'utf8mb4', 'utf8mb4_bin', NULL),
('def', 'hidromania', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'petshop', 'utf8', 'utf8_bin', NULL),
('def', 'restaurante', 'utf8mb4', 'utf8mb4_unicode_ci', NULL),
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '2709'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2622'),
('INNODB_BUFFER_POOL_PAGES_DATA', '264'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '28'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7927'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '2957'),
('INNODB_BUFFER_POOL_READS', '264'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '36'),
('INNODB_DATA_FSYNCS', '22'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '6508544'),
('INNODB_DATA_READS', '274'),
('INNODB_DATA_WRITES', '32'),
('INNODB_DATA_WRITTEN', '467968'),
('INNODB_DBLWR_PAGES_WRITTEN', '14'),
('INNODB_DBLWR_WRITES', '4'),
...
('def', 'gissa', 'paciente', 0, 'gissa', 'PRIMARY', 1, 'idPaciente', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hidromania', 'adm', 0, 'hidromania', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hidromania', 'clientes', 0, 'hidromania', 'PRIMARY', 1, 'id', 'A', 65, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hidromania', 'frequencia', 0, 'hidromania', 'PRIMARY', 1, 'codigo', 'A', 21, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hidromania', 'funcionario', 0, 'hidromania', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hidromania', 'orcamento', 0, 'hidromania', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hidromania', 'pagamento', 0, 'hidromania', 'PRIMARY', 1, 'codigo', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hidromania', 'pagamentopilates', 0, 'hidromania', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hidromania', 'pilates', 0, 'hidromania', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'petshop', 'agendamento', 0, 'petshop', 'PRIMARY', 1, 'idcliente', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'petshop', 'anamnese', 0, 'petshop', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'petshop', 'animal', 0, 'petshop', 'PRIMARY', 1, 'idAnimal', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'petshop', 'avalicao', 0, 'petshop', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'petshop', 'cliente', 0, 'petshop', 'PRIMARY', 1, 'idcliente', 'A', 10, NULL, NULL, '', 'BTREE', '', ''),
('def', 'petshop', 'diavacina', 0, 'petshop', 'PRIMARY', 1, 'idcliente', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'petshop', 'estoque', 0, 'petshop', 'PRIMARY', 1, 'idproduto', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', 'petshop', 'funcionario', 0, 'petshop', 'PRIMARY', 1, 'idfuncionario', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'petshop', 'gasto', 0, 'petshop', 'PRIMARY', 1, 'idgasto', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'petshop', 'historico', 0, 'petshop', 'PRIMARY', 1, 'idHistorico', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'petshop', 'login', 0, 'petshop', 'PRIMARY', 1, 'idUsuario', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'petshop', 'receita', 0, 'petshop', 'PRIMARY', 1, 'idreceita', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'petshop', 'tosa', 0, 'petshop', 'PRIMARY', 1, 'idtosa', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'restaurante', 'alimentos', 0, 'restaurante', 'PRIMARY', 1, 'id', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'restaurante', 'listarfuncionario', 0, 'restaurante', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'restaurante', 'listarpedido', 0, 'restaurante', 'PRIMARY', 1, 'Id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'restaurante', 'login', 0, 'restaurante', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-08-28 17:58:09', '2017-08-28 17:58:09', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-08-28 17:58:09', '2017-08-28 17:58:09', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-08-28 17:58:09', '2017-08-28 17:58:09', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-08-28 17:58:09', '2017-08-28 17:58:09', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-08-28 17:58:09', '2017-08-28 17:58:09', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-08-28 17:58:09', '2017-08-28 17:58:09', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-08-28 17:58:09', '2017-08-28 17:58:09', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-08-28 17:58:09', '2017-08-28 17:58:09', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-08-28 17:58:09', '2017-08-28 17:58:09', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2017-08-28 17:58:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'gissa', 'paciente', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 8388608, NULL, '2017-06-27 14:04:23', NULL, NULL, 'utf8mb4_bin', NULL, '', ''),
('def', 'hidromania', 'adm', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 8388608, 2, '2017-06-27 14:32:11', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'hidromania', 'clientes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 65, 756, 49152, 0, 0, 8388608, 103, '2017-06-27 14:32:11', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'hidromania', 'frequencia', 'BASE TABLE', 'InnoDB', 10, 'Compact', 21, 780, 16384, 0, 0, 8388608, 23, '2017-06-27 14:32:11', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'hidromania', 'funcionario', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 8388608, 2, '2017-06-27 14:32:11', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'hidromania', 'orcamento', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 8388608, 1, '2017-06-27 14:32:11', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'hidromania', 'pagamento', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 8388608, 2, '2017-06-27 14:32:11', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'hidromania', 'pagamentopilates', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 8388608, 4, '2017-06-27 14:32:12', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'hidromania', 'pilates', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 8388608, 4, '2017-06-27 14:32:12', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 11:47:18', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 11:47:18', '2011-12-16 21:03:09', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 11:47:18', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 11:47:18', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 465, 197, 91605, 55450570411999231, 16384, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1028, 9, 9252, 2533274790395903, 19456, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 867, 440716, 281474976710655, 20480, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 11:47:20', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 11:47:20', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 11:47:20', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 11:47:20', '2011-12-16 21:03:09', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2011-12-16 21:03:09', '2012-01-25 11:47:20', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 11:47:20', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 11:47:20', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 11:47:20', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 53, 212, 281474976710655, 2048, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 11:47:20', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'petshop', 'agendamento', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 8388608, 1, '2017-07-07 13:17:54', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'petshop', 'anamnese', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 8388608, 6, '2017-07-07 13:17:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'petshop', 'animal', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 0, 8388608, 7, '2017-07-07 13:17:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'petshop', 'avalicao', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 8388608, NULL, '2017-07-07 13:17:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'petshop', 'cliente', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 0, 8388608, 13, '2017-07-07 13:17:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'petshop', 'debito', 'BASE TABLE', 'InnoDB', 10, 'Compact', 18, 910, 16384, 0, 0, 8388608, NULL, '2017-07-07 13:17:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'petshop', 'diavacina', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 8388608, 4, '2017-07-07 13:17:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'petshop', 'estoque', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 8388608, 6, '2017-07-07 13:17:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'petshop', 'funcionario', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 8388608, 4, '2017-07-07 13:17:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'petshop', 'gasto', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 8388608, 3, '2017-07-07 13:17:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'petshop', 'historico', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 8388608, 3, '2017-07-07 13:17:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'petshop', 'login', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 8388608, 2, '2017-07-07 13:17:56', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'petshop', 'receita', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 8388608, 3, '2017-07-07 13:17:56', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'petshop', 'tosa', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 8388608, 14, '2017-07-07 13:17:56', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'petshop', 'vendas', 'BASE TABLE', 'InnoDB', 10, 'Compact', 21, 780, 16384, 0, 0, 8388608, NULL, '2017-07-07 13:17:56', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'restaurante', 'alimentos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 0, 8388608, 8, '2017-07-07 13:17:16', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'restaurante', 'listarfuncionario', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 8388608, 3, '2017-07-07 13:17:16', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'restaurante', 'listarpedido', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 8388608, 11, '2017-07-07 13:17:16', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'restaurante', 'login', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 8388608, 2, '2017-07-07 13:17:16', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'restaurante', 'totaldia', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 0, 8388608, NULL, '2017-07-07 13:17:16', NULL, NULL, 'latin1_swedish_ci', NULL, '', '');

-- --------------------------------------------------------

--
-- Estrutura da tabela `TABLESPACES`
--
...
('def', 'gissa', 'PRIMARY', 'gissa', 'paciente', 'PRIMARY KEY'),
('def', 'hidromania', 'PRIMARY', 'hidromania', 'adm', 'PRIMARY KEY'),
('def', 'hidromania', 'PRIMARY', 'hidromania', 'clientes', 'PRIMARY KEY'),
('def', 'hidromania', 'PRIMARY', 'hidromania', 'frequencia', 'PRIMARY KEY'),
('def', 'hidromania', 'PRIMARY', 'hidromania', 'funcionario', 'PRIMARY KEY'),
('def', 'hidromania', 'PRIMARY', 'hidromania', 'orcamento', 'PRIMARY KEY'),
('def', 'hidromania', 'PRIMARY', 'hidromania', 'pagamento', 'PRIMARY KEY'),
('def', 'hidromania', 'PRIMARY', 'hidromania', 'pagamentopilates', 'PRIMARY KEY'),
('def', 'hidromania', 'PRIMARY', 'hidromania', 'pilates', 'PRIMARY KEY'),
...
('def', 'petshop', 'PRIMARY', 'petshop', 'agendamento', 'PRIMARY KEY'),
('def', 'petshop', 'PRIMARY', 'petshop', 'anamnese', 'PRIMARY KEY'),
('def', 'petshop', 'PRIMARY', 'petshop', 'animal', 'PRIMARY KEY'),
('def', 'petshop', 'PRIMARY', 'petshop', 'avalicao', 'PRIMARY KEY'),
('def', 'petshop', 'PRIMARY', 'petshop', 'cliente', 'PRIMARY KEY'),
('def', 'petshop', 'PRIMARY', 'petshop', 'diavacina', 'PRIMARY KEY'),
('def', 'petshop', 'PRIMARY', 'petshop', 'estoque', 'PRIMARY KEY'),
('def', 'petshop', 'PRIMARY', 'petshop', 'funcionario', 'PRIMARY KEY'),
('def', 'petshop', 'PRIMARY', 'petshop', 'gasto', 'PRIMARY KEY'),
('def', 'petshop', 'PRIMARY', 'petshop', 'historico', 'PRIMARY KEY'),
('def', 'petshop', 'PRIMARY', 'petshop', 'login', 'PRIMARY KEY'),
('def', 'petshop', 'PRIMARY', 'petshop', 'receita', 'PRIMARY KEY'),
('def', 'petshop', 'PRIMARY', 'petshop', 'tosa', 'PRIMARY KEY'),
('def', 'restaurante', 'PRIMARY', 'restaurante', 'alimentos', 'PRIMARY KEY'),
('def', 'restaurante', 'PRIMARY', 'restaurante', 'listarfuncionario', 'PRIMARY KEY'),
('def', 'restaurante', 'PRIMARY', 'restaurante', 'listarpedido', 'PRIMARY KEY'),
('def', 'restaurante', 'PRIMARY', 'restaurante', 'login', 'PRIMARY KEY');
...
--
-- Estrutura da tabela `INNODB_CMP_RESET`
--
...
--
-- Extraindo dados da tabela `INNODB_CMP_RESET`
--
...
--
-- Estrutura da tabela `INNODB_TRX`
--
...
--
-- Estrutura da tabela `INNODB_CMPMEM_RESET`
--
...
--
-- Extraindo dados da tabela `INNODB_CMPMEM_RESET`
--
...
--
-- Estrutura da tabela `INNODB_LOCK_WAITS`
--
...
--
-- Estrutura da tabela `INNODB_CMPMEM`
--
...
--
-- Extraindo dados da tabela `INNODB_CMPMEM`
--
...
--
-- Estrutura da tabela `INNODB_CMP`
--
...
--
-- Extraindo dados da tabela `INNODB_CMP`
--
...
--
-- Estrutura da tabela `INNODB_LOCKS`
--
...
--
-- Estrutura da tabela `cond_instances`
--
...
--
-- Estrutura da tabela `events_waits_current`
--
...
--
-- Estrutura da tabela `events_waits_history`
--
...
--
-- Estrutura da tabela `events_waits_history_long`
--
...
--
-- Estrutura da tabela `events_waits_summary_by_instance`
--
...
--
-- Estrutura da tabela `events_waits_summary_by_thread_by_event_name`
--
...
--
-- Estrutura da tabela `events_waits_summary_global_by_event_name`
--
...
--
-- Estrutura da tabela `file_instances`
--
...
--
-- Estrutura da tabela `file_summary_by_event_name`
--
...
--
-- Estrutura da tabela `file_summary_by_instance`
--
...
--
-- Estrutura da tabela `mutex_instances`
--
...
--
-- Estrutura da tabela `performance_timers`
--
...
--
-- Extraindo dados da tabela `performance_timers`
--
...
--
-- Estrutura da tabela `rwlock_instances`
--
...
--
-- Estrutura da tabela `setup_consumers`
--
...
--
-- Extraindo dados da tabela `setup_consumers`
--
...
--
-- Estrutura da tabela `setup_instruments`
--
...
--
-- Estrutura da tabela `setup_timers`
--
...
--
-- Extraindo dados da tabela `setup_timers`
--
...
--
CREATE DATABASE `petshop` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `petshop`;
...
CREATE TABLE IF NOT EXISTS `anamnese` (
  ...
  `QueixaPrincipal` varchar(100) DEFAULT NULL,
  `Historico` varchar(600) DEFAULT NULL,
  `Vacinacao` varchar(100) DEFAULT NULL,
  `vermifugacao` varchar(100) DEFAULT NULL,
  `Alimentacao` varchar(100) DEFAULT NULL,
  `DoencasAnteriores` varchar(100) DEFAULT NULL,
  `Ambiente` varchar(100) DEFAULT NULL,
  `Contactantes` varchar(100) DEFAULT NULL,
  `MedicacaoUtilizada` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `anamnese` (`id`, `NomeCliente`, `QueixaPrincipal`, `Historico`, `Vacinacao`, `vermifugacao`, `Alimentacao`, `DoencasAnteriores`, `Ambiente`, `Contactantes`, `MedicacaoUtilizada`) VALUES
(1, 'Vinícius Nunes Barbosa', 'dor', 'nenhum', 'tal', 'sim', 'ração', 'vomito ', 'quintal', 'nãos ei', 'nenhuma'),
(3, 'nunes', 'dor', 'nenhum', 'tal', 'sim', 'ração', 'vomito ', 'quintal', 'nãos ei', 'nenhuma'),
(4, 'José', 'dor', 'nenhum', 'tal', 'sim', 'ração', 'vomito ', 'quintal', 'nãos ei', 'nenhuma'),
(5, 'lupy', 'dor', 'nenhum', 'tal', 'sim', 'ração', 'vomito ', 'quintal', 'nãos ei', 'nenhuma');
...
CREATE TABLE IF NOT EXISTS `animal` (
  ...
  `vacinas` varchar(80) NOT NULL,
  `informacoes` varchar(999) NOT NULL,
...
INSERT INTO `animal` (`idAnimal`, `nome`, `sexo`, `data_nasc`, `peso`, `especie`, `raca`, `cor`, `vacinas`, `informacoes`, `dataRegistro`, `NomeDono`) VALUES
(1, 'lupy', 'Macho ', '00/00/0000', '15', 'cão', 'pinche', 'preto', 'gjhhhghg', 'saudável', '24/08/2015', 'Vinícius Nunes Barbosa'),
(2, 'lupy', 'Macho ', '00/00/0000', '15', 'cão', 'pinche', 'preto', 'gjhhhghg', 'saudável', '24/08/2015', 'Vinícius Nunes Barbosa'),
(3, 'lupy', 'Macho ', '00/00/0000', '15', 'cão', 'pinche', 'preto', 'gjhhhghg', 'saudável', '02/03/2016', 'Barbosa'),
(4, 'lupy', 'Macho ', '00/00/0000', '', '', '', '', '', '', '02/03/2016', 'Barbosa'),
(5, 'lupy', 'Macho ', '00/00/0000', '', '', '', '', '', '', '02/03/2016', 'Barbosa'),
(6, 'lupy', 'Macho ', '00/00/0000', '15', 'cão', 'pinche', 'preto', 'gjhhhghg', 'saudável', '24/08/2015', 'Vinícius Nunes Barbosa');
...
CREATE TABLE IF NOT EXISTS `avalicao` (
  ...
  `EstadoGeral` varchar(200) NOT NULL,
  `Temp` varchar(200) NOT NULL,
  `Hidratacao` varchar(200) NOT NULL,
  `Linfonodos` varchar(200) NOT NULL,
  `FC` varchar(200) NOT NULL,
  `Pulso` varchar(200) NOT NULL,
  `FR` varchar(200) NOT NULL,
  `Mucosas` varchar(200) NOT NULL,
  `Olhos` varchar(200) NOT NULL,
  `Orelhas` varchar(200) NOT NULL,
  `Ectoparasitas` varchar(200) NOT NULL,
  `Pele` varchar(200) NOT NULL,
  `Cardiovascular` varchar(200) NOT NULL,
  `Respiratorio` varchar(200) NOT NULL,
  `Digestorio` varchar(200) NOT NULL,
  `Reprodutivo` varchar(200) NOT NULL,
  `Neurologico` varchar(200) NOT NULL,
  `Urinario` varchar(200) NOT NULL,
  `DiagnosticoProvavel` varchar(600) NOT NULL,
  `ExamesComplementares` varchar(500) NOT NULL,
  `ResultadoExames` varchar(500) NOT NULL,
  `DiagnosticoDefinitivo` varchar(500) NOT NULL,
  `Prognosticos` varchar(500) NOT NULL,
  `Tratamento` varchar(500) NOT NULL,
  `Retornos` varchar(500) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `avalicao`
--

INSERT INTO `avalicao` (`id`, `NomeCliente`, `EstadoGeral`, `Temp`, `Hidratacao`, `Linfonodos`, `FC`, `Pulso`, `FR`, `Mucosas`, `Olhos`, `Orelhas`, `Ectoparasitas`, `Pele`, `Cardiovascular`, `Respiratorio`, `Digestorio`, `Reprodutivo`, `Neurologico`, `Urinario`, `DiagnosticoProvavel`, `ExamesComplementares`, `ResultadoExames`, `DiagnosticoDefinitivo`, `Prognosticos`, `Tratamento`, `Retornos`) VALUES
(1, 'nunes', '0909090', 'w', 'wjjh', 'whjhj', 'w,hf', 'wbhbhbh', 'whbhb', 'hbhbh', 'hbhbh', 'jj', 'k', 'jb', 'jbkh', ' 1234567', 'kn', 'jbvjbgjb', 'h hjgjg', 'khhk', 'jvh di', '', 'hfdibybk', 'osjo	', 'jfkdldld', 'aldofju', 'asdfghjklç'),
(2, 'Vinícius Nunes Barbosa', '0909090', 'w', 'wjjh', 'whjhj', 'w,hf', 'wbhbhbh', 'whbhb', 'hbhbh', 'hbhbh', 'jj', 'k', 'jb', 'jbkh', ' 1234567', 'kn', 'jbvjbgjb', 'h hjgjg', 'khhk', 'jvh di', '', 'hfdibybk', 'osjo	', 'jfkdldld', 'aldofju', 'asdfghjklç'),
(7, 'Vinícius Nunes Barbosa', '0909090', 'w', 'wjjh', 'whjhj', 'w,hf', 'wbhbhbh', 'whbhb', 'hbhbh', 'hbhbh', 'jj', 'k', 'jb', 'jbkh', ' 1234567', 'kn', 'jbvjbgjb', 'h hjgjg', 'khhk', 'jvh di', '', 'hfdibybk', 'osjo	', 'jfkdldld', 'aldofju', 'asdfghjklç');
...
INSERT INTO `cliente` (`idcliente`, `nome`, `endereco`, `sexo`, `bairro`, `cidade`, `uf`, `cep`, `operadora`, `celular`, `telefone`, `email`, `rg`, `cpf`, `data_nasc`) VALUES
(1, 'nunes', 'rua tal', 'Masculino', 'tall', 'aracati', 'CE', '62800-000', '', '(00) 00000-0000', '(00) 0000-0000', 'nunununununununununununununununu', '111111111111111', '1111111111111', '00/00/0000'),
(3, 'Vinícius Nunes Barbosa', 'Rua Teófilo Pinto', 'Masculino', 'Farias Brito', 'Aracati', 'CE', '62800-000', 'Claro', '(88) 99609-4289', '(00) 00000-0000', 'vinicius_nb1@hotmail.com', '111111111111111', '070.187.023-05', '04/08/1998'),
(5, 'Vinícius Nunes Barbosa', 'Rua Teófilo Pinto', 'Masculino', 'Farias Brito', 'Aracati', 'CE', '62800-000', 'Claro', '(88) 99609-4289', '(  )      -    ', 'vinicius_nb1@hotmail.com', '111111111111111', '070.187.023-05', '04/08/1998'),
(6, 'Vinícius Nunes Barbosa', 'Rua Teófilo Pinto', 'Masculino', 'Farias Brito', 'Aracati', 'CE', '62800-000', 'Claro', '(88) 99609-4289', '(  )      -    ', 'vinicius_nb1@hotmail.com', '111111111111111', '070.187.023-05', '04/08/1998'),
(7, 'José', 'Rua Teófilo Pinto', 'Masculino', 'Farias Brito', 'Aracati', 'CE', '62800-000', 'Claro', '(88) 99609-4289', '(  )      -    ', 'vinicius_nb1@hotmail.com', '111111111111111', '070.187.023-05', '04/08/1998'),
(8, 'Vinícius Nunes Barbosa', 'Rua Teófilo Pinto', 'Masculino', 'Farias Brito', 'Aracati', 'CE', '62800-000', 'Claro', '(88) 99609-4289', '(  )      -    ', 'vinicius_nb1@hotmail.com', '111111111111111', '070.187.023-05', '04/08/1998'),
(9, 'Vinícius Nunes Barbosa', 'Rua Teófilo Pinto', 'Masculino', 'Farias Brito', 'Aracati', 'CE', '62800-000', 'Claro', '(88) 99609-4289', '(  )      -    ', 'vinicius_nb1@hotmail.com', '111111111111111', '070.187.023-05', '04/08/1998'),
(10, 'Barbosa', 'rua tal', 'Masculino', 'tall', 'aracati', 'CE', '62800-000', 'Claro', '(00) 00000-0000', '(  )      -    ', 'nunununununununununununununununu', '111111111111111', '1111111111111', '00/00/0000'),
(11, 'Barbosa', 'rua tal', 'Masculino', 'tall', 'aracati', 'CE', '62800-000', 'Claro', '(00) 00000-0000', '(  )      -    ', 'nunununununununununununununununu', '111111111111111', '1111111111111', '00/00/0000'),
(12, 'Barbosa', 'rua tal', 'Masculino', 'tall', 'aracati', 'CE', '62800-000', 'Claro', '(00) 00000-0000', '(  )      -    ', 'nunununununununununununununununu', '111111111111111', '1111111111111', '00/00/0000');
...
INSERT INTO `debito` (`idcliente`, `nome`, `valor`) VALUES
(2, 'Vinícius Nunes Barbosa', 10),
(2, 'Vinícius Nunes Barbosa', 10),
(2, 'Vinícius Nunes Barbosa', 10),
(2, 'Vinícius Nunes Barbosa', 10),
(2, 'Vinícius Nunes Barbosa', 10),
...
--
-- Estrutura da tabela `diavacina`
--

CREATE TABLE IF NOT EXISTS `diavacina` (
  `idcliente` int(11) NOT NULL AUTO_INCREMENT,
  `nomecliente` varchar(100) NOT NULL,
...
--
-- Extraindo dados da tabela `diavacina`
--

INSERT INTO `diavacina` (`idcliente`, `nomecliente`, `animal`, `data`, `hora`, `status`) VALUES
(2, 'Jessé Lima', 'Cachorro boby', '08/09/2015', '10:00', 'vacina de sarampo e carrapaticida'),
(3, 'Nunes', 'luppy', '17/02/2016', '10:00', 'vacina de sarampo e carrapaticida');
...
INSERT INTO `estoque` (`idproduto`, `produto`, `quantidade`, `preco`, `datacompra`, `datavalidade`) VALUES
(1, 'Remédio ', 1, 15, '09/09/2015', '10/10/2015'),
(2, 'Ração', 2, 10, '09/09/2015', '04/08/1998'),
(3, 'Coleira', 47, 10, '09/09/2015', '10/10/2040'),
(4, 'Carrapaticida', 40, 8, '09/09/2015', '10/10/2040'),
(5, 'Shampo', 47, 10, '09/09/2015', '10/10/2040');
...
INSERT INTO `funcionario` (`idfuncionario`, `nome`, `endereco`, `sexo`, `cidade`, `bairro`, `uf`, `celular`, `cpf`, `rg`, `cep`, `email`, `data_nasc`, `funcao`) VALUES
(2, 'nunes', 'jdhgjhgj', 'Masculino', 'jjhvfhfj', 'kjgvfhkfj', 'CE', '(00) 00000-0000', '2222222222', '111111111', '09909-090', 'nvnvnvnvnv@', '00/00/0000', 'auxiliar'),
(3, 'Vinícius Nunes Barbosa', 'Rua Teófilo Pinto , 152', 'Masculino', 'Aracati', 'Farias Brito', 'CE', '(88) 99609-4289', '2222222222', '111111111', '62800-000', 'vinicius_nb1@hotmail.com', '04/08/1998', 'Gerente');
...
INSERT INTO `gasto` (`idgasto`, `produto`, `quantidade`, `preco`, `dia`, `mes`, `ano`) VALUES
(1, 'Ração', 1, 10, '4', 'Agosto', '2015'),
(2, 'Remédio', 20, 60, '14', 'Setembro', '2015');
...
CREATE TABLE IF NOT EXISTS `historico` (
  ...
  `nomecliente` varchar(100) NOT NULL,
  `data` varchar(10) NOT NULL,
  `servico` varchar(10000) NOT NULL,
...
INSERT INTO `historico` (`idHistorico`, `idcliente`, `nomecliente`, `data`, `servico`) VALUES
(2, 3, 'Vinícius Nunes Barbosa', '19/08/2015', 'gfff\njjphf\nyfg\nnhgfg\n');
...
INSERT INTO `receita` (`idreceita`, `cliente`, `animal`, `receita`, `sintomas`, `observacao`) VALUES
(1, 'Vinícius Nunes Barbosa', 'lupy', 'receita', 'budgvudgv', 'p\nç\nç\nç\nç\nç\nçooo\nç\n\n\n~ç\njvgduvgdsuv'),
(2, 'Vinícius Nunes Barbosa', 'lupy', 'receita', 'budgvudgv', 'jvgduvgdsuv');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tosa`
--

CREATE TABLE IF NOT EXISTS `tosa` (
  `idtosa` int(11) NOT NULL AUTO_INCREMENT,
  `nome_animal` varchar(255) NOT NULL,
  `nome_dono` varchar(255) NOT NULL,
  `raca` varchar(255) NOT NULL,
  `horario_chegada` varchar(255) NOT NULL,
  `horario_entregue` varchar(255) NOT NULL,
  `banho` varchar(255) NOT NULL,
  `deixou_guia` varchar(255) DEFAULT NULL,
  `tosa` varchar(255) DEFAULT NULL,
  `retirada_de_pelo` varchar(255) DEFAULT NULL,
  `presença_de_parasitas` varchar(255) DEFAULT NULL,
  `encaminhamento` varchar(255) DEFAULT NULL,
  `lesoes_pele` varchar(255) DEFAULT NULL,
  `quais` varchar(255) DEFAULT NULL,
  `secrecao_ouvido` varchar(255) DEFAULT NULL,
  `coloracao` varchar(255) DEFAULT NULL,
  `obs` varchar(255) DEFAULT NULL,
  `obsBanho` varchar(100) DEFAULT NULL,
  `obsTosa` varchar(100) DEFAULT NULL,
  `Tosador` varchar(100) DEFAULT NULL,
  `Banhista` varchar(100) DEFAULT NULL,
  `data` varchar(20) NOT NULL,
  PRIMARY KEY (`idtosa`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=14 ;

--
-- Extraindo dados da tabela `tosa`
--

INSERT INTO `tosa` (`idtosa`, `nome_animal`, `nome_dono`, `raca`, `horario_chegada`, `horario_entregue`, `banho`, `deixou_guia`, `tosa`, `retirada_de_pelo`, `presença_de_parasitas`, `encaminhamento`, `lesoes_pele`, `quais`, `secrecao_ouvido`, `coloracao`, `obs`, `obsBanho`, `obsTosa`, `Tosador`, `Banhista`, `data`) VALUES
(4, 'tooby', 'Barbosa', 'pinche', '11:11', '11:11', 'Sim', 'Sim', 'Não', 'Sim', 'Sim', 'Sim', 'Não', 'sarna', 'Não', '88', 'calasar		', '', '', '', '', '17/02/2016'),
(8, 'marley', 'Nunes', 'pinche', '11:11', '11:11', 'Sim', 'Sim', 'Sim', 'Sim', NULL, NULL, NULL, '', NULL, '', '', 'Sim', 'tosa', 'barbosa', 'nunes', '17/02/2016'),
(12, 'lupy', 'Vinícius Nunes Barbosa', 'pinche', '00:00', '12:00', 'Sim', 'Sim', 'Sim', 'Sim', 'Sim', 'Não', 'Não', '1', 'Não', '2', '...', 'a	', 'b', '4', '3', '17/02/2016'),
(13, 'ralf', 'Maria de tal', 'pinche', '00:00', '12:00', 'Sim', 'Sim', 'Sim', 'Sim', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'a	', 'b', NULL, NULL, '17/02/2016');
...
INSERT INTO `vendas` (`idvenda`, `idcliente`, `cliente`, `produto`, `quatidade`, `codproduto`, `preco`, `dia`, `mes`, `ano`, `totalvenda`, `totalservico`, `tiposervico`, `vezes`, `cartao`, `status`) VALUES
(2, NULL, NULL, 'Remédio ', 1, 1, 15, '04', 'Dezembro', '2015', 15, 0, NULL, NULL, NULL, 'finalizado'),
(2, NULL, NULL, 'Coleira', 2, 3, 10, '04', 'Dezembro', '2015', 20, 0, NULL, NULL, NULL, 'finalizado'),
(1, NULL, NULL, 'Remédio ', 1, 1, 15, '04', 'Dezembro', '2015', 15, 0, NULL, NULL, NULL, 'finalizado'),
(1, NULL, NULL, 'Carrapaticida', 2, 4, 8, '05', 'Dezembro', '2015', 16, 0, NULL, NULL, NULL, 'finalizado'),
(1, NULL, NULL, 'Remédio ', 1, 1, 15, '05', 'Dezembro', '2015', 15, 0, NULL, NULL, NULL, 'finalizado'),
(1, NULL, NULL, 'Remédio ', 2, 1, 15, '05', 'Dezembro', '2015', 30, 0, NULL, NULL, NULL, 'finalizado'),
(1, NULL, NULL, 'Remédio ', 2, 1, 15, '17', 'Fevereiro', '2016', 30, 0, NULL, NULL, NULL, 'finalizado'),
(1, NULL, NULL, 'Ração', 3, 2, 10, '17', 'Fevereiro', '2016', 30, 0, NULL, NULL, NULL, 'finalizado'),
(1, NULL, NULL, 'Remédio ', 6, 1, 15, '17', 'Fevereiro', '2016', 90, 0, NULL, NULL, NULL, 'finalizado'),
(1, NULL, NULL, 'Remédio ', 2, 1, 15, '02', 'Março', '2016', 30, 0, NULL, NULL, NULL, 'finalizado'),
(1, NULL, NULL, 'Ração', 3, 2, 10, '02', 'Março', '2016', 30, 0, NULL, NULL, NULL, 'finalizado'),
(1, NULL, NULL, 'Coleira', 40, 3, 10, '02', 'Março', '2016', 400, 0, NULL, NULL, NULL, 'finalizado'),
(4, NULL, NULL, 'Remédio ', 7, 1, 15, '03', 'Março', '2016', 105, 0, NULL, NULL, NULL, 'finalizado'),
(6, NULL, NULL, 'Ração', 40, 2, 10, '1', 'Janeiro', '2016', 400, 0, NULL, NULL, NULL, 'finalizado'),
(8, NULL, NULL, 'Carrapaticida', 8, 4, 8, '1', 'Janeiro', '2016', 64, 0, NULL, NULL, NULL, 'finalizado'),
(8, NULL, NULL, 'Coleira', 7, 3, 10, '1', 'Janeiro', '2016', 70, 0, NULL, NULL, NULL, 'finalizado'),
(2, NULL, NULL, 'Ração', 1, 2, 10, '02', 'Março', '2016', 10, 0, NULL, NULL, NULL, 'finalizado'),
(2, NULL, NULL, 'Shampo', 7, 5, 10, '02', 'Março', '2016', 70, 0, NULL, NULL, NULL, 'finalizado'),
(2, NULL, NULL, 'Shampo', 7, 5, 10, '02', 'Março', '2016', 70, 0, NULL, NULL, NULL, 'finalizado'),
(2, NULL, NULL, 'Shampo', 7, 5, 10, '02', 'Março', '2016', 70, 0, NULL, NULL, NULL, 'finalizado'),
(2, NULL, NULL, 'Shampo', 7, 5, 10, '02', 'Março', '2016', 70, 0, NULL, NULL, NULL, 'finalizado');
--
...
--
CREATE DATABASE `restaurante` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `restaurante`;
...
(1, 'Crostini misto', 45),
(2, 'Crostini de Bacalhau', 57),
(3, 'Polpo Aglio i Limone', 50),
(4, 'Brusquetta de Búfala', 65),
(5, 'Brusquetta al Pesto', 64),
(6, 'Água', 2),
(7, 'Macarronada', 6);
...
(1, 'Feminino', 'Ângela Amaro de Freitas', '0123456789.0', '012.345.678-97', '(00)0000-0000', '18/09/1998', 'Sitio jardim', 'hgg', '62815-000', 'angela10flamengo@gmail.com'),
(2, 'Masculino', 'Vinícius Nunes Barbosa', '0123456789.0', '012.345.678-97', '(00)0000-0000', '18/09/1998', 'Teófilo Pinto', 'FB', '62800-000', 'nuneso@gmail.com');
...
INSERT INTO `listarpedido` (`Id`, `Mesa`, `CodPedido`, `pedido`, `quantidade`, `preco`, `total`, `status`, `nome`) VALUES
(2, 2, 4, 'Brusquetta de Búfala', 2, 65, 130, 'Reservado', 'Samya');
...
--
-- Extraindo dados da tabela `totaldia`
--

INSERT INTO `totaldia` (`data`, `valor`) VALUES
('08/05/2015', '90'),
('13/05/2015', '325'),
('14/05/2015', '90'),
('30/05/2015', '640'),
